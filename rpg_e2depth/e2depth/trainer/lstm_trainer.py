...
class LSTMTrainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        if self.use_psf and hasattr(self.model, 'unetrecurrentpsf'):
            os.makedirs("0903_off_E300_P20_D_15_delta_nosoft_point01", exist_ok=True)
            ...
            with torch.no_grad():
                ...
                torch.save(psfs, f"0903_off_E300_P20_D_15_delta_nosoft_point01/epoch_{epoch:03d}.pt")
